...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_model', nargs='+', type=str, default='Biometry_weights.pt', help='model.pt path(s)')
    parser.add_argument('--deep_sort_model', type=str, default='osnet_x0_25')
    parser.add_argument('--source', type=str, default='C:/Tracker/static/uploads/video.mp4', help='source')  # file/folder, 0 for webcam
