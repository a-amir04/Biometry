...
def video():
    if request.method == 'POST':
        os.system('python track.py --yolo_model Biometry_weights.pt --save-vid --save-txt')
...
def result():
    if request.method == 'POST':
        os.remove('C:/Tracker/static/uploads/video.mp4')
        os.remove('C:/Tracker/static/video.txt')
        os.remove('C:/Tracker/static/video.mp4')
        shutil.rmtree('C:/Tracker/runs/track/Biometry_weights_osnet_x0_25')
        return redirect('http://127.0.0.1:5000')
